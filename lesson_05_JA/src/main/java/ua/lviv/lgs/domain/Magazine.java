...
public class Magazine {
	...
	public String toString() {
		if (id == 0)
			return "Журнал [назва=" + title + ", опис=" + description + ", дата публікації=" + publishDate
					+ ", ціна підписки=" + subscribePrice + "]";
		else
			return "Журнал [id=" + id + ", назва=" + title + ", опис=" + description + ", дата публікації="
					+ publishDate + ", ціна підписки=" + subscribePrice + "]";
	}
}
