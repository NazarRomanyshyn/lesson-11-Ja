    ...
    <div class="login-page">
        <div class="form">
            <form class="register-form">
                ...
                <p class="message">Ви вже зареєстровані? <a href="#">Вихід</a></p>
            </form>
            <form class="login-form">
                <input class="email" type="text" placeholder="Логін" />
                <input class="password" type="password" placeholder="Пароль" />
                <button class="login" type="button">Вихід</button>
                <p class="message">Ще не зареєстровані? <a href="#">Створити акаунт</a></p>
            </form>
        </div>
    </div>
